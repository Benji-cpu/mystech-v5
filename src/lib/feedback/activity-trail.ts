 ...
 * admin can reproduce the bug instead of guessing at "the deck reveal hung."
 *
 * Captured event kinds:
 *   - "route":    pathname changed
 *   - "click":    a clickable element with [data-event] was tapped (or any button/link)
...
export function installActivityTrail(): void {
  ...
  // Clicks on tagged elements (or any button/link)
