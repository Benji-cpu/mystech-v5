...
export const ART_STYLE_PRESETS = [
  ...
  },
  {
    ...
    stylePrompt: 'Still life composition. Byzantine mosaic oracle card, tessellated gold leaf background with glass tesserae texture, frontal hieratic composition with elongated proportions and solemn stillness, rich palette of gold, deep crimson, royal purple, and lapis blue, ornate halo patterns, architectural arches and dome motifs, sacred geometry and divine light radiating from symbolic forms',
    stabilityPreset: 'fantasy-art',
    category: 'classical',
  },
  {
  ...
  },
  {
    ...
    stylePrompt: 'Still life composition. Ukiyo-e woodblock print oracle card in the landscape tradition of the Thirty-six Views of Mount Fuji, bold black outlines with flat areas of vivid color, dramatic wave and mountain motifs, stylized clouds and pine branches, palette of indigo blue, vermillion red, sage green, and cream, visible wood grain texture, cartouche text panels, atmospheric perspective through layered planes of color',
    // NOT 'line-art' — that preset forces monochrome linework and strips out the
    // flat vivid colour that defines ukiyo-e. Keep line-art for the styles that
    // really are ink-only: pen-and-ink, woodcut-linocut, medical-anatomical.
    stabilityPreset: 'digital-art',
    category: 'classical',
  },
  ...
  },
  {
    ...
    stylePrompt: 'Stained glass window oracle card with thick dark lead came lines separating jewel-tone glass segments, luminous backlit translucency effect with light streaming through colored glass, Gothic cathedral rose window composition, deep ruby red, sapphire blue, emerald green, and amber gold with pure white highlights, sacred symbolic emblems in medieval ecclesiastical style, radiant divine light',
    stabilityPreset: 'digital-art',
    category: 'photography',
  },
  {
  ...
  },
  {
    ...
    stylePrompt: 'Victorian era oracle card with elaborate ornamental filigree border, sepia-toned engraving style with fine crosshatching, cameo medallions and ornamental silhouette motifs, decorative scrollwork and acanthus leaf patterns, palette of sepia brown, dusty mauve, bottle green, and antique gold, calling card and cabinet photo aesthetic, velvet and lace texture, refined parlor elegance and spiritualist séance atmosphere',
    stabilityPreset: 'analog-film',
    category: 'period',
  },
  {
    ...
    // '3d-model' rendered this as CG product shots; the style is an illustration.
    stabilityPreset: 'fantasy-art',
    category: 'period',
  },
  {
