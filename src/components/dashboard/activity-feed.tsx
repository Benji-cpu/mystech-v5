...
function formatRelativeTime(date: Date, isFuture: boolean): string {
  const now = Date.now();
...
function getActivityIcon(item: ActivityItemWithTemporal): LucideIcon {
  switch (item.type) {
...
function getActivityText(item: ActivityItemWithTemporal): React.ReactNode {
  switch (item.type) {
    case "deck_created":
...
function getActivityHref(item: ActivityItemWithTemporal): string | null {
  switch (item.type) {
    ...
    case "astrology_setup": return "/profile";
...
function getRowStyle(item: ActivityItemWithTemporal) {
...
function getDescription(item: ActivityItemWithTemporal): string | null {
...
function ActivityRow({ item }: { item: ActivityItemWithTemporal }) {
