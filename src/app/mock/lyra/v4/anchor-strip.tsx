  ...
  return (
    <div className={cn("flex flex-col gap-1.5", className)}>
      ...
      <div className="flex items-center gap-2 px-1">
        <span className="text-[9px] uppercase tracking-widest text-white/25 shrink-0">Anchors</span>
          ...
          {anchors.map((anchor) => {
            ...
            return (
              <motion.button
                ...
                className={cn(
                  "snap-start shrink-0 flex items-center gap-1.5 h-9 px-3 rounded-full touch-manipulation transition-shadow duration-200",
