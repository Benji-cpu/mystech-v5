...
export type PathPhase =
  | "overview"          // Retreat intro, see the full trail, set intention
  | "waypoint"          // At a waypoint — context shown immediately
...
export interface PathJourneyState {
  ...
  userIntention: string;              // set once in overview, persists across waypoints
  ...
  switch (action.type) {
    ...
    case "ADVANCE_COMPLETE":
      return {
        ...
        interpretationText: "",
        isTimeLocked: false,
        // userIntention persists across waypoints
        userReflection: "",
        reflectionSkipped: false,
      };
