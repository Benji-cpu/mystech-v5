  ...
  return (
    <div className="min-h-screen bg-background px-4 sm:px-6 py-8 sm:py-12">
      <div className="mx-auto max-w-2xl">
        <h1 className="text-2xl sm:text-3xl font-bold tracking-tight">Landing Page Mocks</h1>
        <p className="mt-2 text-sm sm:text-base text-muted-foreground">
          4 landing page approaches. Each is fully responsive — compare at 375px, 768px, and 1280px+.
        </p>
        ...
        <p className="mt-8 text-center text-xs text-muted-foreground">
          Click any mock to view the full landing page.
        </p>
      </div>
    </div>
  );
